...
import com.magnus.library.service.CategoryService;
...
public class ProductController {
    ...
    @GetMapping("/products")
    private String product(Model model, Principal principal) {
        //check-login
        if (principal == null) {
    ...
    public String saveProduct(@ModelAttribute("product") ProductDto productDto,
        ...
        try {
            ...
            e.printStackTrace();
            attributes.addFlashAttribute("failed", "Error! fail to add");
        }
    ...
    public String processUpdate(@PathVariable("id") Long id,
        ...
        try {
            ...
            e.printStackTrace();
            attributes.addFlashAttribute("failed", "Fail to update");
        }
        return "redirect:/products/0";
    }
    ...
    public String searchProducts(@PathVariable("pageNo") int number,
        ...
        Page<ProductDto> products = productService.searchProducts(number, keyword);
